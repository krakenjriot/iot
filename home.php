                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-md font-weight-bold text-primary text-uppercase mb-1">
                                                Others (<?php echo $online_switches + $offline_switches; ?>)</div>
                                            <div class="h2 mb-0 font-weight-bold text-gray-800"><?php echo $online_switches ."/". $offline_switches; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-toggle-on fa-2x text-gray-300"></i>											
                                    ...
                                    <form class="user" action="?p=4" method="post">              
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Board Name..." name="board_name" >
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                ...
                <div class="modal-body">
                                    <form class="user" action="?p=4" method="post">              
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Name..." name="server_name" >
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Description..." name="server_desc">
                                        </div>
										
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="IP Address..." name="server_ip">
                                        </div>	
										
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Location..." name="server_location">
                                        </div>	
										
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Time Zone..." name="server_timezone">
                                        </div>	
										
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Htdocs Directory..." name="htdocs_dir">
                                        </div>		
