...
function update_list($board_name)
{
    ...
    else
    {
        ...
        $sql = "INSERT INTO tbl_url (active, board_name, server_ip, url, pins, server_name, htdocs_dir, exe_dir, server_timezone, board_refresh_sec)
  		VALUES ($active, '$board_name', '$server_ip', '$url', '$pins', '$server_name', '$htdocs_dir', '$exe_dir', '$server_timezone', '$board_refresh_sec')";
        $conn->query($sql);
    }
...
function update_list($board_name){
	...
	$url = "http://". $server_ip . "/portty/api/?b=$board_name&p=$pins&conf_dir=$conf_dir";	
	$response = "";
	...
	{
		//not present perform insert
		$sql = "INSERT INTO tbl_url (board_name, server_ip, url, pins, server_name, conf_dir)
  		VALUES ('$board_name', '$server_ip', '$url', '$pins', '$server_name', '$conf_dir')";
  		$conn->query($sql);		
	}
