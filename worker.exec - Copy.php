...
if (mysqli_num_rows($result) > 0)
{
    ...
    while ($row = mysqli_fetch_assoc($result))
    {
        ...
        if (check_root_url_reachable($root_url))
        {
            ...
            $web_service_s = 1;
            ///////////////////////////////////////////////
            $sql = "UPDATE tbl_servers SET " . " web_service = 1 " . "WHERE server_ip = '$server_ip' ";
            $conn->query($sql);
            ///////////////////////////////////////////////
        ...
        else
        {
            ...
            $web_page_s = 0;
            ///////////////////////////////////////////////
            $sql = "UPDATE tbl_servers SET " . " web_service = 0, " . " web_page = 0 " . "WHERE server_ip = '$server_ip' ";
            $conn->query($sql);
            ///////////////////////////////////////////////
        ...
        if (!empty($server_ip))
        {
            if ($web_service_s == 1)
            {
                if ($web_page_s == 1)
                {
                    ...
                    //$url = "http://". $server_ip . "/portty/api/?b=$board_name&p=$pins&exe_dir=$exe_dir&server_timezone=$server_timezone";
